...
function Map() {
    const _src = `https://maps.googleapis.com/maps/api/staticmap?center=${lat},${long}&zoom=16&size=${900}x${500}&markers=anchor:32,10%7Cicon:https://goo.gl/5y3S82%7CCanberra+ACTsize:mid%7Ccolor:red|${lat},${long}&key=${GOOGLE_API_KEY}`;
